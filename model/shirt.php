...
class Shirt extends Model {
    ...
    public function __construct($dsn, $user, $password) {
        ...
        $this->selectSQL = 'select id, name, title, collor, prise, picture, description, material from shirt order by id desc';
        $this->countSQL = 'select count(*) from shirt';
        $this->insertSQL = 'insert into shirt (name, title, collor, prise, picture, description, material) values (?, ?, ?, ?, ?, ?, ?)';
        $this->updateformSQL = 'select name, title, collor, prise, picture, description, material from shirt where id=?';
        $this->updateSQL = 'update shirt set name=?, title=?, collor=?, prise=?, picture=?, description=?, material=? where id=?';
        $this->deleteSQL = 'delete from shirt where id=?';
        $this->aboutSQL = 'select name, title, collor, prise, picture, description, material from shirt where id=?';
