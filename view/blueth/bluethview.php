...
class Bluethview{
    ...
    private function create() {
        if ($this->requestObject->isPOST && !$this->dataObject->error) {
            ...
            $url = $_SERVER['SCRIPT_NAME'] . '?model=blueth&command=create&page=' . $this->requestObject->page;
    ...
    private function update() {
        if ($this->requestObject->isPOST && !$this->dataObject->error) {
            ...
            $url = $_SERVER['SCRIPT_NAME'] . '?model=blueth&command=update&page=' . $this->requestObject->page . '&id=' . $this->requestObject->id;
	...
	private function about() {
        if ($this->requestObject->isPOST && !$this->dataObject->error) {
            ...
            $url = $_SERVER['SCRIPT_NAME'] . '?model=blueth&command=about&page=' . $this->requestObject->page . '&id=' . $this->requestObject->id;
            $caption = 'ABOUT';
    ...
    private function redirect($page) {
        header("Location: http://{$_SERVER['SERVER_NAME']}{$_SERVER['SCRIPT_NAME']}?model=blueth&page=$page");
        exit();
    }
}
